...
#endif
	{"cpdf_set_annotation",		php3_cpdf_set_annotation,	NULL},
...
/* {{{ proto cpdf_set_creator(int pdfdoc, string creator)
...
/* {{{ proto pdf_set_title(int pdfptr, string title)
...
/* {{{ proto pdf_set_subject(int pdfptr, string subject)
...
/* {{{ proto pdf_set_keywords(int pdfptr, string keywords)
...
/* {{{ proto void cpdf_set_annotation(int pdfdoc, double xll, double yll, double xur, double xur, string title, string text[, int mode])
   Sets annotation */
void php3_cpdf_set_annotation(INTERNAL_FUNCTION_PARAMETERS) {
	pval *argv[11];
	int id, type, argc, mode=0;
	int *pdf;
