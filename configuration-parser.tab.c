...
static const short yyrline[] = { 0,
   333,   335,   338,   352,   353,   361,   378,   382,   384,   387,
   389,   390,   391
};
#endif
...
case 3:
#line 339 "configuration-parser.y"
{
#if 0
...
{ free(yyvsp[0].value.str.val); ;
    break;}
case 5:
#line 353 "configuration-parser.y"
{
			pval dummy;
#if 0
...
{ yyval = yyvsp[0]; ;
    break;}
case 10:
#line 388 "configuration-parser.y"
{ yyval = yyvsp[0]; ;
    break;}
case 11:
#line 389 "configuration-parser.y"
{ yyval = yyvsp[0]; ;
    break;}
case 12:
#line 390 "configuration-parser.y"
{ yyval = yyvsp[0]; ;
    break;}
case 13:
#line 391 "configuration-parser.y"
...
#line 401 "configuration-parser.y"
